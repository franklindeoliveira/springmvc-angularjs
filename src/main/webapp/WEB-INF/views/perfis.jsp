		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-md-offset-4 col-sm-offset-4">
					...
					<div class="row">
						<div class="col-md-12">
							<h2>Perfil deste usuário: <sec:authentication property="principal.authorities" /></h2>
						</div>
					</div>
					<div class="row">
						<sec:authorize access="hasRole('ROLE_PERFIL1')">
							<div class="col-md-12">
								<p>
									Área acessível apenas para usuários com o perfil "ROLE_PERFIL1".
								</p>
							</div>
						</sec:authorize>
						<sec:authorize access="hasRole('ROLE_PERFIL2')">
							<div class="col-md-12">
								<p>
									Área acessível apenas para usuários com o perfil "ROLE_PERFIL2".
								</p>
							</div>
						</sec:authorize>
						<sec:authorize access="hasRole('ROLE_PERFIL3')">
							<div class="col-md-12">
								<p>
									Área acessível apenas para usuários com o perfil "ROLE_PERFIL3".
								</p>
							</div>
						</sec:authorize>
						<sec:authorize access="hasRole('ROLE_PERFIL1') or hasRole('ROLE_PERFIL2')">
							<div class="col-md-12">
								<p>
									Área acessível apenas para usuários com o perfil "ROLE_PERFIL1" ou "ROLE_PERFIL2" .
								</p>
							</div>
						</sec:authorize>
						<sec:authorize access="hasRole('ROLE_PERFIL1') or hasRole('ROLE_PERFIL3')">
							<div class="col-md-12">
								<p>
									Área acessível apenas para usuários com o perfil "ROLE_PERFIL1" ou "ROLE_PERFIL3".
								</p>
							</div>
						</sec:authorize>
						<sec:authorize access="hasRole('ROLE_PERFIL2') or hasRole('ROLE_PERFIL3')">
							<div class="col-md-12">
								<p>
									Área acessível apenas para usuários com o perfil "ROLE_PERFIL2" ou "ROLE_PERFIL3".
								</p>
							</div>
						</sec:authorize>
					</div>
